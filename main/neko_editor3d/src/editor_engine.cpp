...
PYBIND11_EMBEDDED_MODULE(neko, m)
{
    ...
    py::class_<neko::Radian>(m, "radian")
        .def("value", &neko::Radian::GetValue);
    py::class_<neko::Vec2f>(m, "Vec2f")
        .def(py::init<>())
        .def(py::init<float>())
        .def(py::init<float, float>())
        .def_property_readonly_static("zero", &neko::Vec2f::zero)
        .def_property_readonly_static("one", &neko::Vec2f::one)
        .def_property_readonly_static("left", &neko::Vec2f::left)
        .def_property_readonly_static("right", &neko::Vec2f::right)
        .def_property_readonly_static("up", &neko::Vec2f::up)
        .def_property_readonly_static("down", &neko::Vec2f::down)
        //properties
    ...
    py::class_<neko::Vec3f>(m, "Vec3f")
        ...
        .def_property_readonly_static("zero", &neko::Vec3f::zero)
        .def_property_readonly_static("one", &neko::Vec3f::one)
        .def_property_readonly_static("left", &neko::Vec3f::left)
        .def_property_readonly_static("right", &neko::Vec3f::right)
        .def_property_readonly_static("up", &neko::Vec3f::up)
        .def_property_readonly_static("down", &neko::Vec3f::down)
        .def_property_readonly_static("forward", &neko::Vec3f::forward)
        .def_property_readonly_static("back", &neko::Vec3f::back)
        //operators
        .def(py::self + py::self)
        .def(py::self += py::self)
        .def(-py::self)
    ...
    py::class_<neko::Mat4f>(m, "Mat4f")
        ...
        .def_property_readonly_static("identity", &neko::Mat4f::identity)
        .def_property_readonly_static("zero", &neko::Mat4f::zero)
        //operators
        .def(py::self + py::self)
        .def(py::self - py::self)
