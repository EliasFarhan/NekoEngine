...
set_target_properties(easy_profiler PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libeasy_profiler.so"
  IMPORTED_SONAME_RELEASE "libeasy_profiler.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS easy_profiler )
list(APPEND _IMPORT_CHECK_FILES_FOR_easy_profiler "${_IMPORT_PREFIX}/lib/libeasy_profiler.so" )
