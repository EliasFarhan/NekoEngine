...
function(add_neko_test binary)
	...
	target_link_libraries(${test_bin_name} ${binary} GTest::gtest GTest::gtest_main)
	target_include_directories(${test_bin_name} PUBLIC ${GOOGLE_TEST_DIR}/include)
	add_test(NAME ${test_bin_name} COMMAND ${test_bin_name} )
	target_compile_options(${test_bin_name} PRIVATE ${NEKO_COMPILE_FLAGS})
	target_link_options(${test_bin_name} PRIVATE ${NEKO_link_FLAGS})
